...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('binalerts_dataimport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upload_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('binalerts', ['DataImport'])


    def backwards(self, orm):
        
        # Deleting model 'DataImport'
        db.delete_table('binalerts_dataimport')
