...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CollectionAlert.last_sent_date'
        db.add_column('binalerts_collectionalert', 'last_sent_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CollectionAlert.last_sent_date'
        db.delete_column('binalerts_collectionalert', 'last_sent_date')
